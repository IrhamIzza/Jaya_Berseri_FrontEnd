                                ...
                                <div class="row gy-2 overflow-hidden">
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            autocomplete="current-email" id="email" placeholder="name@example.com" required>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            autocomplete="current-password" name="password" id="password" value="" placeholder="Password" required>
