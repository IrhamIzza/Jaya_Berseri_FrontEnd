...
<template>
    <div class="flex h-screen">
        ...
        <main class="flex-1 p-6 bg-gray-100 overflow-auto">
            <h1 class="text-2xl font-bold text-center mb-4">DATA ARTIKEL</h1>
            <div v-if="loading" class="mt-24">
                <div class="flex flex-col items-center ">
                    <svg class="motion-safe:animate-spin size-24" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <p class="font-semibold text-xl">Processing....</p>
                </div>
            </div>
            <TableArticle v-else :items="artikel">
            </TableArticle>
        </main>
    </div>
